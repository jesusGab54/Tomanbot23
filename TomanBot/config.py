...
class Development(Config):
    ...
    TIGER_USERS = [21396580, 954299697, 5010209835, 5676170494, 5492224551, 5516142677]
    TOKEN="5911693677:AAFp4N42pdcC8qdI0y1OhRpSIi9idXxmyOE"
    GBAN_LOGS = True
    API_ID=22381167
    API_HASH="2989ad215b7b81ec5ca936a615db51d0"
    CASH_API_KEY=  False
    TIME_API_KEY="UISFHDG2FJG5"
    AI_API_KEY= False
    WALL_API= False
    SUPPORT_CHAT = '-1001891927588'
    SPAMWATCH_SUPPORT_CHAT = 'SpamWatchSupport'
    SPAMWATCH_API = 'uLHMHL2aFwsi0QRCDtzwbhKIpVBBPf487Sv4yPO9MCPXqgMR2VddxycKPc9ljVm3'
    BL_CHATS = []
